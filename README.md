...
Recipe cache shard for **[foodrecipes.page](https://foodrecipes.page)** — AI-generated recipes whose slug starts with **the letter 'k'**.
...
```
https://cdn.jsdelivr.net/gh/foodrecipes-page/recipes-k@main/recipes/<cuisine>/<diet>/<slug>.json
```
